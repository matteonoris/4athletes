class ExerciseDef {
  ...
  final String category; // 'barbell' | 'dumbbell' | 'machine' | 'cable' | 'bodyweight' | 'kettlebell' | 'band'

  const ExerciseDef(this.id, this.name, this.targetMuscle, this.category);
}
...
const List<ExerciseDef> exerciseDatabase = [
  ...
  ExerciseDef('cable_fly_high', 'Cable High-to-Low Fly',        'Petto Basso',    'cable'),
  ...
  ExerciseDef('db_bent_raise',  'Bent-Over Rear Delt Raise',    'Deltoide Post.', 'dumbbell'),
  ...
  ExerciseDef('shoulder_press_m','Shoulder Press Machine',      'Spalle',         'machine'),
  ExerciseDef('rear_delt_m',    'Rear Delt Machine Fly',        'Deltoide Post.', 'machine'),
  ...
  ExerciseDef('neutral_pullup', 'Neutral-Grip Pull-Up',         'Dorsali',        'bodyweight'),
  ExerciseDef('inverted_row',   'Inverted Row (Bodyweight)',     'Dorsali',        'bodyweight'),
  ExerciseDef('lat_pulldown',   'Lat Pulldown (Presa Larga)',   'Dorsali',        'machine'),
  ExerciseDef('lat_pd_close',   'Lat Pulldown Presa Stretta',   'Dorsali',        'machine'),
  ExerciseDef('seat_row',       'Seated Cable Row',             'Dorsali',        'cable'),
  ExerciseDef('seat_row_wide',  'Seated Cable Row (Presa Larga)','Dorsali',       'cable'),
  ExerciseDef('cable_pullover', 'Cable Pullover',               'Dorsali',        'cable'),
  ExerciseDef('tbar_row',       'T-Bar Row',                    'Dorsali',        'machine'),
  ExerciseDef('back_ext',       'Back Extension / Hyperextension','Lombari',      'machine'),
  ...
  ExerciseDef('hammer_curl',    'Hammer Curl',                  'Bicipiti / Brachiorad.','dumbbell'),
  ...
  ExerciseDef('close_grip_bp',  'Close-Grip Bench Press',       'Tricipiti',      'barbell'),
  ExerciseDef('db_tri_ext',     'Dumbbell Tricep Extension',    'Tricipiti',      'dumbbell'),
  ExerciseDef('db_kickback',    'Tricep Kickback',              'Tricipiti',      'dumbbell'),
  ExerciseDef('cable_pushdown', 'Cable Pushdown (Presa Dritta)','Tricipiti',      'cable'),
  ...
  ExerciseDef('machine_tri',    'Tricep Machine Extension',     'Tricipiti',      'machine'),
  ...
  ExerciseDef('glute_machine',  'Glute Machine / Donkey Kick',  'Glutei',         'machine'),
  ...
  ExerciseDef('lateral_sq',     'Lateral Squat / Skater Squat', 'Gambe',          'bodyweight'),
  ...
  // CORE - ADDOME
  // ═══════════════════════════════════════
  ExerciseDef('plank',          'Plank',                        'Core',           'bodyweight'),
  ...
  ExerciseDef('landmine_twist', 'Landmine Rotational Press',    'Obliqui',        'barbell'),
  ...
  ExerciseDef('clean_grip_dl',  'Clean-Grip Deadlift',          'Schiena / Gambe','barbell'),
  ...
  ExerciseDef('comp_deadlift',  'Competition Deadlift',         'Schiena / Gambe','barbell'),
  ...
  ExerciseDef('box_deadlift',   'Deadlift da Box / Deficit',    'Schiena / Gambe','barbell'),
  ...
  ExerciseDef('kb_windmill',    'Kettlebell Windmill',          'Core / Spalle',  'kettlebell'),
  ExerciseDef('kb_turkish',     'Turkish Get-Up',               'Corpo Intero',   'kettlebell'),
  ExerciseDef('kb_deadlift',    'Kettlebell Deadlift',          'Schiena / Gambe','kettlebell'),
  ...
  ExerciseDef('mountain_cl',    'Mountain Climbers',            'Core / Cardio',  'bodyweight'),
  ...
  ExerciseDef('sprint',         'Sprint (Accelerazioni)',       'Gambe / Cardio', 'bodyweight'),

  // ═══════════════════════════════════════
  // PREPARAZIONE ATLETICA
  // ═══════════════════════════════════════
  ExerciseDef('med_ball_throw', 'Medicine Ball Throw',          'Corpo Intero',   'bodyweight'),
  ExerciseDef('med_ball_slam',  'Medicine Ball Slam',           'Core / Potenza', 'bodyweight'),
  ...
  ExerciseDef('battling_ropes', 'Battling Ropes',               'Cardio / Braccia','bodyweight'),
  ExerciseDef('box_step_down',  'Box Step-Down (Eccentric)',    'Gambe',          'bodyweight'),
  ...
  ExerciseDef('reverse_nordic', 'Reverse Nordic Curl',          'Quadricipiti',   'bodyweight'),
  ...
  // ═══════════════════════════════════════
  ExerciseDef('hip_circle',     'Hip Circle (Mobilità Anca)',   'Mobilità',       'bodyweight'),
  ExerciseDef('world_greatest', 'World\'s Greatest Stretch',    'Mobilità',       'bodyweight'),
  ExerciseDef('ankle_mob',      'Ankle Mobility Drill',         'Mobilità',       'bodyweight'),
  ExerciseDef('thoracic_rot',   'Thoracic Rotation',            'Mobilità Dorsale','bodyweight'),
